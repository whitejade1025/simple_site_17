        ...
        window.CTCClipboard = (function (e, o, n) {
          ...
          function c() {
            ...
            n.userAgent.match(/ipad|iphone/i)
              ? ((c = o.createRange()).selectNodeContents(t),
          ...
          return (
            (copySelection = function (n) {
              var t = e.getSelection(),
                c = o.createRange();
              c.selectNodeContents(n[0]),
                t.removeAllRanges(),
                t.addRange(c),
                o.execCommand("copy"),
                t.removeAllRanges();
            }),
            {
              copy: function (n) {
                !(function (e) {
                  ((t = o.createElement("textArea")).value = e),
        ...
        (o = {
          ...
          doCopy: function (o) {
            ...
            var n = e(this),
              t =
                n
                  .closest(".wp-block-ctc-copy-icon")
                  .find(".ctc-copy-icon-textarea")
                  .val()
                  .trim() || "";
