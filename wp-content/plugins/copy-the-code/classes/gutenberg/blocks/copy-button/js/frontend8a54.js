        ...
        window.CTCClipboard = (function (e, t, o) {
          ...
          function c() {
            ...
            o.userAgent.match(/ipad|iphone/i)
              ? ((c = t.createRange()).selectNodeContents(n),
          ...
          return (
            (copySelection = function (o) {
              var n = e.getSelection(),
                c = t.createRange();
              c.selectNodeContents(o[0]),
                n.removeAllRanges(),
                n.addRange(c),
                t.execCommand("copy"),
                n.removeAllRanges();
            }),
            {
              copy: function (o) {
                !(function (e) {
                  ((n = t.createElement("textArea")).value = e),
                    t.body.appendChild(n);
                })(o),
                  c(),
                  t.execCommand("copy"),
                  t.body.removeChild(n),
                  "undefined" != typeof copyTheCode &&
                    copyTheCode.redirect_url &&
                    (e.location.href = copyTheCode.redirect_url);
              },
        ...
        (t = {
          ...
          doCopy: function (t) {
            ...
            var o = e(this),
              n =
                o
                  .closest(".ctc-copy-button-wrap")
                  .find(".ctc-copy-button-textarea")
                  .val()
                  .trim() || "",
              c = o.text(),
